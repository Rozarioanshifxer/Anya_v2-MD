...
module.exports = {
     ...
     */
    botname: process.env.BotName || " ᴀɴsʜɪғ xᴇʀ ᴠ2",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲  ᴀɴsʜɪғ xᴇʀ 𝐁𝐨𝐭",
    ...
    ownernumber: process.env.Owner_Number || "916282524515",
    instagramId: process.env.Insta || "anshif_xer",

    /**
     * other details and parameters
     */
    author: process.env.Author || " ᴀɴsʜɪғ xᴇʀ 🌚🌙",
    packname: process.env.PackName || " ᴀɴsʜɪғ xᴇʀ 𝖁2 𝕾𝖙𝖎𝖈𝖐𝖊𝖗 𝕻𝖆𝖈𝖐 🪀",
    socialLink: process.env.Web || "https://github.com/PikaBotz",
    groupLink: process.env.GcLink || "https://chat.whatsapp.com/EEjye2ZQyzh1j0hIbZuO6Y",
    warns: Number(process.env.Warn_Limits) || 3,
    cooldown: Number(process.env.Cooldown_Timer_Seconds) || 5, // default cooldown time per command in seconds
    mongoUrl: process.env.MongoDB || "mongodb+srv://ja850738:N9PnkwWXAl90bD0N@cluster0.q9ylq.mongodb.net/",
    sessionId: process.env.SESSION_ID || "aTBzbnc_Queen-Anya_0dTQ=",
